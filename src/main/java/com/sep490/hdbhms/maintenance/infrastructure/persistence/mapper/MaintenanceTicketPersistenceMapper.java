...
public class MaintenanceTicketPersistenceMapper {
    ...
    public MaintenanceTicket toDomain(MaintenanceTicketEntity entity) {
        ...
        return MaintenanceTicket.builder()
                ...
                .externalRepairmanName(entity.getExternalRepairmanName())
                .externalRepairmanPhone(entity.getExternalRepairmanPhone())
                .externalRepairProvider(entity.getExternalRepairProvider())
                .externalRepairNote(entity.getExternalRepairNote())
    ...
    public MaintenanceTicketEntity toEntity(MaintenanceTicket domain) {
        ...
        return MaintenanceTicketEntity.builder()
                ...
                .externalRepairmanName(domain.getExternalRepairmanName())
                .externalRepairmanPhone(domain.getExternalRepairmanPhone())
                .externalRepairProvider(domain.getExternalRepairProvider())
                .externalRepairNote(domain.getExternalRepairNote())
