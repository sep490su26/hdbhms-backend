...
public class RoomTransferRequestPersistenceMapper {
    ...
    public RoomTransferRequest toDomain(RoomTransferRequestEntity entity) {
        ...
        return RoomTransferRequest.builder()
                ...
                .positiveDifferenceSettlementType(entity.getPositiveDifferenceSettlementType())
                ...
                .eligibilityCheckedAt(entity.getEligibilityCheckedAt())
                .eligibleAtCreation(entity.getEligibleAtCreation())
                .eligibilitySnapshot(entity.getEligibilitySnapshot())
                .violationSnapshot(entity.getViolationSnapshot())
                .transferHistorySnapshot(entity.getTransferHistorySnapshot())
    ...
    public RoomTransferRequestEntity toEntity(RoomTransferRequest domain) {
        ...
        return RoomTransferRequestEntity.builder()
                ...
                .approvedById(domain.getApprovedById())
                .approvedAt(domain.getApprovedAt())
                .executedAt(domain.getExecutedAt())
                .completedAt(domain.getCompletedAt())

                .status(domain.getStatus())
                .positiveDifferenceSettlementType(domain.getPositiveDifferenceSettlementType())
                ...
                .replacementOldContract(domain.getReplacementOldContractId() != null
                        ...
                        .orElseThrow(() -> new AppException(ApiErrorCode.ROOM_TRANSFER_REQUEST_NOT_FOUND))
                        : null)
                .eligibilityCheckedAt(domain.getEligibilityCheckedAt())
                .eligibleAtCreation(domain.getEligibleAtCreation())
                .eligibilitySnapshot(domain.getEligibilitySnapshot())
                .violationSnapshot(domain.getViolationSnapshot())
                .transferHistorySnapshot(domain.getTransferHistorySnapshot())
