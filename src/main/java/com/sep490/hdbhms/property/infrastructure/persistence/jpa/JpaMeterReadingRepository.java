...
public interface JpaMeterReadingRepository extends JpaRepository<MeterReadingEntity, Long> {
    ...
    @Query("""
        ...
        WHERE room.id = :roomId
          ...
          AND reading.status <> com.sep490.hdbhms.property.domain.value_objects.ReadingStatus.VOIDED
          AND reading.revisionNo = (
              ...
              WHERE other.meter.id = meter.id
                ...
                AND other.status <> com.sep490.hdbhms.property.domain.value_objects.ReadingStatus.VOIDED
          )
